...
NMilitary = {
	...
	CORPS_COMMANDER_DIVISIONS_CAP = 14,			-- how many divisions a corps commander is limited to. 0 = inf, < 0 = blocked
	...
	FIELD_MARSHAL_DIVISIONS_CAP = 14,			-- how many divisions a field marshall is limited to. 0 = inf, < 0 = blocked
